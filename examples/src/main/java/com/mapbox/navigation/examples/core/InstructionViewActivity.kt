...
class InstructionViewActivity : AppCompatActivity(), OnMapReadyCallback,
    ...
    private fun initListeners() {
        startNavigation.setOnClickListener { startNavigationButton ->
        ...
        override fun onEnhancedLocationChanged(
            ...
            mapboxMap?.let { map ->
                if (keyPoints.isNotEmpty()) {
                    map.locationComponent.forceLocationUpdate(keyPoints, true)
                } else {
                    map.locationComponent.forceLocationUpdate(enhancedLocation)
                }
            }
        }
    }
